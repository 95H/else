<template>
    ...
    <div class="autoIssue-content  marginTop10 ">
      <div class="autoIssue-content-header ">
        <span class="search-btn width100" @click="addRecheckMan">新增签发人</span>
      </div>
        ...
        >
          <el-table-column
            ...
            <template slot-scope="scope">
            	<div class="textOverflow1" :title="scope.row.recheckPersonName">
          ...
          <el-table-column
            ...
            width="180">
            <template slot-scope="scope">
            	<div class="textOverflow1" :title="scope.row.natureName">
          ...
          <el-table-column
            ...
            label="部门">
            <template slot-scope="scope">
            	<div class="textOverflow1" :title="scope.row.deptName">
                 {{ scope.row.deptName }}
              </div>
            </template>    
          </el-table-column>
