...
export default {
  ...
  created() {
    ...
    const hasweizhi = this.hasSomeApiAccess('teaching_courses_students_micro_courses_students_modules_processes')
    const hasjindu = this.hasSomeApiAccess('teaching_courses_students_micro_courses_students_processes')
    const hasxiangqing = this.hasSomeApiAccess('teaching_courses_students_micro_courses_students_details')
    const hasjieduansuo = this.hasSomeApiAccess('teaching_courses_students_micro_courses_students_phases')
    ...
    learnDetailClick(row) {
      ...
      this.$router.push({
        ...
        query: {
          ...
          from: 'class-stu-manage_small-class_see-students'
        }
      })
    },
