<template>
  <div class="stage-week-stat-container">
    <SimpleTable
      table-height="580"
...
export default {
  ...
  computed: {
    ...mapState({
      tableData: state => state.learningStatistics.stageWeekStat.stats,
      weekDateList: state => state.learningStatistics.weekDateList,
      pageInfo: state => state.learningStatistics.stageWeekStat.pageInfo
    }),
  ...
  methods: {
    ...mapMutations({
      resetState: 'learningStatistics/resetStageWeekState'
    }),

    ...mapActions({
      fetchWeekStageStats: 'learningStatistics/fetchWeekStageStats',
    ...
    async fetchTableData() {
      ...
      await this.fetchWeekStageStats(params)
