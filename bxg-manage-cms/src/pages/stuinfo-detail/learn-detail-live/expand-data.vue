<template>
  <div class="expand">
    ...
    >
      ...
      <Table class="module_table" border :loading="loading" :columns="columns1" :data="data1"></Table>
...
<script>
  ...
  export default {
    ...
    data() {
      // 临时放开此按钮权限
      const haschakanzhuangtai = true || this.hasSomeApiAccess('teaching_courses_students_lives_courses_students_details_extensions_modules_status')
